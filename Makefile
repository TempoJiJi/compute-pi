...
default: computepi.o
	...
	$(CC) $(CFLAGS) computepi.o time_test.c -DLOPENMP_2 -o time_test_leibniz_openmp_2
	$(CC) $(CFLAGS) computepi.o time_test.c -DLOPENMP_4 -o time_test_leibniz_openmp_4
	$(CC) $(CFLAGS) computepi.o time_test.c -DLAVX -o time_test_leibniz_avx
	$(CC) $(CFLAGS) computepi.o time_test.c -DLAVXUNROLL -o time_test_leibniz_avxunroll
